...
@Component({
  ...
  template: `
    <h2>User Profile</h2>
    <p>This is the user profile page. You can display user information and settings here.</p>
        ...
        <div class="row">
                  ...
                  <div class="col-lg-6 px-xl-10">
                    ...
                    <ul class="list-unstyled mb-1-9">
                      ...
                      <li class="mb-2 mb-xl-3 display-28">
                        ...
                        {{ authStore.userData()?.email || 'edith@mail.com' }}
                      </li>
                      <li class="mb-2 mb-xl-3 display-28">
                        <span class="display-26 text-secondary me-2 font-weight-600">Website:</span>
                        www.example.com
                      </li>
                      <li class="display-28">
                        <span class="display-26 text-secondary me-2 font-weight-600">Phone:</span>
                        {{ authStore.userData()?.phone || '123-456-7890' }}
                      </li>
                    </ul>
          ...
          <div class="col-lg-12 mb-4 mb-sm-5">
            <div>
              ...
              <p>
                Edith is simply dummy text of the printing and typesetting industry. Lorem Ipsum has
